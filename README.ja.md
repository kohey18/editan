...
<p align="center"><strong>貼り付けたら、プレーンテキスト。</strong><br>ほかのアプリの文章を、プレーンテキストで扱える Mac の作業場所。</p>
...
Web やメール、ほかのアプリでコピーした文章を Editan にペースト。**元のフォントや色を持ち込まず、プレーンテキストとして展開されます。** 揃った見た目で編集し、次のアプリに合う書式でコピーできる macOS 専用エディタです。
...
- **貼り付けたら、プレーンテキスト。** 普通の **⌘V** で、エディタの見た目に揃えて取り込めます。いろいろなアプリから集めた文章も、そのまま編集。Markdown の構文ハイライトは Editan 側の表示です。
...
1. **⌘N** で新しい下書きを作り、**⌘V** で文章を貼り付けるか、自分で書く。
